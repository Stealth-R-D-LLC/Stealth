#ifndef QPAGEADDRBOOK_H
#define QPAGEADDRBOOK_H
...
/** Widget that shows a list of sending or receiving addresses.
  */
class QPageAddrBook : public QStealthPage
{
    Q_OBJECT
...
public:
    ...
    explicit QPageAddrBook(Mode mode, Tabs tab, QWidget *parent = 0);
