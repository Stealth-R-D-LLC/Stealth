...
#include "feature/transport_config.h"
#include "lib/geoip.h"
#include "feature/geoip_stats.h"
#include "lib/compress.h"
#include "lib/structvar.h"
...
#ifdef ENABLE_NSS
#include "lib/crypto_nss_mgt.h"
#else
#include "lib/crypto_openssl_mgt.h"
#endif
...
get_data_directory(const char *val)
{
  ...
  {
    return tor_strdup(coin_tor_data_directory());
  }
#else /* !defined(_WIN32) */
  const char *d = val;
  if (d)
